...
const Logo = () => (
  <div className="text-blue-900 dark:text-white text-2xl font-bold">
    Nav Shiksha
  </div>
);
const LogoIcon = () => (
  ...
  const links = [
    {
      ...
      href: "/student-home",
      icon: (
        <IconBrandTabler className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Dashboard",
      ...
      icon: (
        <IconPencil className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "LeaderBoard",
      href: "#",
      icon: (
        <IconTrophy className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Doubt-Section",
      href: "/doubt",
      icon: (
        <IconBook className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Community",
    ...
    },
    {
      ...
      href: "#",
      icon: (
        <IconMessageCircle className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    ...
    },
    {
      ...
      href: "/setting",
      icon: (
        <IconSettings className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
    {
      label: "Logout",
      href: "/student-login",
      icon: (
        <IconArrowLeft className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" />
      ),
    },
  ];
  return (
