...
const SidebarComponent = (components:any) => {
  ...
  const links = [
        ...
        { label: "Dashboard", href: "/teacher-dashboard", icon: <IconPencil className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" /> },
        { label: "Attendance", href: "/attendance", icon: <IconBrandTabler className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" /> },
        {
                    label: "Community",
        ...
        { label: "Settings", href: "/setting", icon: <IconSettings className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" /> },
        { label: "Logout", href: "/parent-login", icon: <IconArrowLeft className="text-blue-700 dark:text-neutral-200 h-5 w-5 flex-shrink-0" /> },
    ];
    return (
        <>
